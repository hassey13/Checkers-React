...
const Rules = ( props ) => {
  ...
  return (
    <div className={ props.show ? 'rules' : 'hide' } >
    <div className='rules-dismiss' onClick={ props.onDismiss } >X</div>
      <p>Rules</p>
      <p>Checkers is played on a standard 64 square board. Only the 32 white colored squares are used in play. Each player begins the game with 12 pieces, or checkers, placed in the three rows closest to him or her. The object of the game is to capture all of your opponent’s checkers or position your pieces so that your opponent has no available moves. </p>
      <p>Basic movement is to move a checker one space diagonally forward. You can not move a checker backwards until it becomes a King, as described below. If a jump is available, you must take the jump, as described in the next question and answer. </p>
